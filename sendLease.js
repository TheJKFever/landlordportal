...
var 	email = 'byanofsky@me.com',				// your account email
    	password = 'ot8-c3G-CYU-rUE',			// your account password
    	integratorKey = 'ef74ef87-a54b-49a9-b4ce-b3945c2d2e6f',			// your Integrator Key (found on the Preferences -> API page)
		recipientName = "Brandon",			// recipient (signer) name
        documentName = "./pdf/Lease-Agreement.pdf",			// copy document with this name into same directory!
    	baseUrl = ""; 				// we will retrieve this through the Login call

function sendLease(email) {
        ...
        function(next) {
    		...
    		var body = {
                ...
                "eventNotification": {
                    ...
                    "url": "https://84efc960.ngrok.io/notification",
                    "loggingEnabled": "true",
                },
                "documents": [{
    				"name": documentName,
